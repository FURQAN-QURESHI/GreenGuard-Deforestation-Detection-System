...
// feat(dataset): add cloud-masking to image retrieval (v2)

// feat(dataset): integrate Planetary Computer STAC client (v3)

// feat(dataset): add retry logic for failed STAC queries (v4)

// feat(dataset): add multi-year temporal stacking (v5)

// feat(dataset): export labeled CSV with coordinates (v6)

// chore(dataset): add progress logging during download

// feat(dataset): add seasonal composite generation (v7)

// feat(dataset): add geographic metadata export (v8)

// feat(dataset): multi-region parallel fetching (v9)
